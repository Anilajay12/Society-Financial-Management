        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" style="color: #ffffff" href="adminWelcome.jsp">Home<span class="sr-only">(current)</span></a>
                </li>
			...
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Plot type</label> <input type="text" readonly="readonly"
						value="<c:out value='${user.plotType}' />" class="form-control" hidden=""
						name="plottype">
				</fieldset>
				
				<fieldset class="form-group">
					<label>Plot Number</label> <input type="text" readonly="readonly" hidden=""
						value="<c:out value='${user.plotno}' />" class="form-control"
						name="plotno">
				</fieldset>
				
				<fieldset class="form-group">
					<label>Rent Amount</label> <input type="text" readonly="readonly" hidden=""
						value="<c:out value='${user.rent}' />" class="form-control"
						name="phone">
				</fieldset>
