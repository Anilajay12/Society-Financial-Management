...
<title>Old Customer Details</title>
		...
		<div class="container">
			...
			<div class="container text-left">
				...
				<a href="<%=request.getContextPath()%>/newUser" class="btn btn-success">Add
					...
					<a href="<%=request.getContextPath()%>/PastUserList" class="btn btn-success">Show Past Customer Details</a>
				...
				<tbody>
					...
					<c:forEach var="user" items="${listUsers}">
						...
						<tr>
							...
							<td><c:out value="${user.familymembercount}" /></td>
