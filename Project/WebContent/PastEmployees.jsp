			...
			<table class="table table-bordered" style="text-align: center;width: auto;">
				<thead>
					<tr>
						...
						<th>EmailId</th>
						<th width="250px">DOB<br><sub>(YYYY-MM-DD)</sub></th>
						<th width="250px">DOJ<br><sub>(YYYY-MM-DD)</sub></th>
						<th>Address</th>
						<th>Contact</th>
						<th>Gender</th>
						<th width="250px">Date Of Leave</th>
					</tr>
				</thead>
				<tbody>
					<!--   for (Todo todo: todos) {  -->
					<c:forEach var="emp" items="${listPastEmployees}">
