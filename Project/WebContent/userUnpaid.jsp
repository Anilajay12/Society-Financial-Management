...
<div class="row">
		...
		<div class="container">
			<h3 class="text-center">Your Unpaid Bills</h3>
			<hr>
			<div class="container text-left">
				<a href="<%=request.getContextPath()%>/userUnpaidBill" class="btn btn-success">Show My Unpaid Bills</a> <marquee>The Maintainance bill will be generated on 5<sup>th</sup> of  every month &amp; Pay your bill before 10<sup>th</sup> to avoid the late fee</marquee>&emsp;&emsp;&emsp;
			</div>
			<br>
			<table class="table table-bordered">
				...
				<tbody>
					...
					<c:forEach var="maintain" items="${listMaintain}">
						...
						<tr>
							<td hidden=""><c:out value="${maintain.id }"/></td>
							...
							<td><a href="PayMaintainance?id=<c:out value='${maintain.id}' />" class="btn btn-success">Pay Bill</a></td>
