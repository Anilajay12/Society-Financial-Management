			...
			<div class="right">
				...
				<form method="post" action="Login">
					...
					<div class="form-group">
						<label style="margin-left: 40px">Email address</label> <input name="email" required class="form-control-input"
						 placeholder="Enter EmailId" oninvalid="this.setCustomValidity('Email cannot be empty or Enter valid Email ID')" 
onchange="this.setCustomValidity('')" type="email" style="width: 70%;margin-left: 25px" />
					</div>
					<div class="form-group">
...
onchange="this.setCustomValidity('')" type="password" style="width: 70%;margin-left: 25px" />
					</div>
					<br>&emsp;&emsp;
