		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="row">
                ...
                <div class="container">
                    ...
                    <h3 class="text-center">List of Contact Requests</h3>
                    <hr><a href="<%=request.getContextPath()%>/FeedbackList" class="btn btn-success" style="margin-leftx: 20%;">Show Feedback Requests</a>&emsp;&emsp;&emsp;
                        ...
                        <tbody>
                            ...
                            <c:forEach var="feedback" items="${listFeedback}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <c:out value="${feedback.emailId}" />
                                    </td>
                                    <td>
                                        <c:out value="${feedback.message}" />
                                    </td>
                                    <td>
                                    	<c:out value="${feedback.requestTime }"/>
                                    </td>
                                    <td><a href="FeedbackDelete?id=<c:out value='${feedback.id}' />"><button type="submit" class="btn btn-danger">Delete Request</button></a></td>
                                </tr>
                            </c:forEach>
                            <!-- } -->
                        </tbody>
