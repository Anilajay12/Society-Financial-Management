...
<script type="text/javascript"
	src="http://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=GjmHSuM9tXSZyJEIlf3EE1Mg4jduRGMWco-tfBbEcLVsd_wnTxZqbhF5yaj7s6x5fTa8xRQu0gsiuiSN9mr2cg"
	charset="UTF-8"></script>
<link rel="stylesheet"
	href="http://gc.kis.v2.scr.kaspersky-labs.com/E3E8934C-235A-4B0E-825A-35A08381A191/abn/main.css?attr=aHR0cDovL2xvY2FsaG9zdDo4MDgwL3NvY2lldHkvVXNlckxpc3Q" />
<style>
* {
	padding: 0;
	margin: 0;
...
<body>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link" style="color: #ffffff"
					href="UserList.jsp">Manage Users</a></li>
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<c:if test="${role=='user' }">
							<a class="dropdown-item" href="userPaidBill">Your paid bills</a>
							<a class="dropdown-item" href="userUnpaidBill">Your unpaid
								bills</a>
						</c:if>
						<c:if test="${role!='user' }">
							<a class="dropdown-item" href="PaidBills">Paid bills</a>
							<a class="dropdown-item" href="UnpaidBills">Unpaid bills</a>
						</c:if>
						<c:if test="${role=='admin' }">
				...
				<ul class="nav justify-content-end">
					<c:if test="${role== 'user'}">
						<li class="nav-item"><a class="nav-link active"
							href="profile"><i class="fa fa-user" aria-hidden="true"></i>View
								Profile</a></li>
					</c:if>
					<c:if test="${role== 'employee'}">
						<li class="nav-item"><a class="nav-link active"
							href="Employeeprofile"><i class="fa fa-user"
	...
	<div class="container col-md-5">
		<div class="card">
			<h3 class="text-center">View Bills</h3><hr>
			<div class="card-body">
			<form method="post" action="totalMaintainance">
				<fieldset class="form-group">
					<label>Choose start Date</label> <input type="date" class="form-control"
						name="startdate" required="required">
				</fieldset>
				<fieldset class="form-group">
					<label>Choose end Date</label> <input type="date" class="form-control"
						name="enddate" required="required">
				</fieldset>
				<input type="submit" value="View Bill Amounts" class="btn btn-success">
				<br><Br>
				</form>
	...
	<table class="table table-bordered" style="text-align: center;width: auto;">
				<thead>
					<tr>
						<th>Start Date</th>
						<th>End Date</th>
						<th>Collected Maintainance</th>
						<th>Events Charges</th>
						<th>Total Remaining Balance</th>
			</tr>
			</thead>
			<tbody>
				<tr>
						<td><c:out value="${report.get(2)}" /></td>
						<td><c:out value="${report.get(3) }"/></td>
						<td><c:out value="${report.get(0)}" /></td>
						<td><c:out value="${report.get(1) }"/></td>
						<td><c:out value="${report.get(0)-report.get(1)}" /></td>
