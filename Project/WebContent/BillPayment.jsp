			...
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>Name</label> <input type="text"
						value="<c:out value='${bill.name}' />" class="form-control" readonly="readonly"
						name="name">
				</fieldset>

				<fieldset class="form-group">
					<label>Email ID</label> <input type="text" readonly="readonly"
						value="<c:out value='${bill.email}' />" class="form-control"
						name="email">
				</fieldset>

				<fieldset class="form-group">
					<label>Your Plot Number: </label> <input type="text" readonly="readonly"
						value="<c:out value='${bill.plotno}' />" class="form-control"
						name="plotno">
				</fieldset>
					
				<fieldset class="form-group">
					<label>Your Maintainance Bill</label> <input type="text" readonly="readonly"
						value="<c:out value='${bill.maintainace}' />" class="form-control"
						name="maintainance">
				</fieldset>
				
				<fieldset class="form-group">
					<label>Your Late Fine</label> <input type="text" readonly="readonly"
						value="<c:out value='${bill.extra}' />" class="form-control"
						name="extra">
				</fieldset>
				
				<fieldset class="form-group">
					<label>Your Total Bill</label> <input type="text" readonly="readonly"
						value="<c:out value='${bill.total}' />" class="form-control"
						name="total">
				</fieldset>
				<br>&emsp;&emsp;
				<button type="submit" class="btn btn-success" style="width: 250px; margin-left: 15px;">Pay Bill</button>
				&emsp;&emsp;<br>
